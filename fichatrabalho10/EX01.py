...
# path do ficheiro
ficheiro = "fichatrabalho10/files/presencas.txt"
...
def renderConsulta():
    ...
    img1 = customtkinter.CTkImage(Image.open("fichatrabalho10/images/lupa.png"), size=(64, 64))
    btnConsultar = customtkinter.CTkButton(frameCons, width = 220, height= 100, image = img1, text = "", 
                        command =consultaMovimentos(cb1, cb2, utilizador, tree))
...
imageIco1 = customtkinter.CTkImage(Image.open("fichatrabalho10/images/icoOp1.png"), size=(64, 64))
...
imageIco2 = customtkinter.CTkImage(Image.open("fichatrabalho10/images/icoOp2.png"), size=(64, 64))
...
imageIco4 = customtkinter.CTkImage(Image.open("fichatrabalho10/images/icoOp4.png"), size=(64, 64))
...
imageLabel = customtkinter.CTkImage(Image.open("fichatrabalho10/images/presencas.png"), size=(750, 500))
